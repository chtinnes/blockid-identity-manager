...
public class IdAssertionTo {
	...
	public String toString() {
		return this.getIdentityAssertionReceiverAddressBase64() + this.getIdentityAttributeName()
				+ this.getIdentityAttributeValueEncBase64() + this.getIdentityAssertionSecretEncBase64();
	}
}
